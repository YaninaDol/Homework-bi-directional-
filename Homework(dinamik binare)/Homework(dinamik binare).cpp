...
int main()
{
	...
	std::cout << "is 3 in list?\t" << numbs.isInList(3) << "\n";
	std::cout << "is 33 in list?\t" << numbs.isInList(33) << "\n";

	std::cout << "\n\n\n";
	//numbs.removeFromList(1);
	//numbs.removeFromList(2);
	numbs.removeFromList(3);

	numbs.removeFromList(65);
	numbs.showList();
}
